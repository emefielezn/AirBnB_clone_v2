--the a database name hbnb_test_db
...
GRANT SELECT ON performance_schema.sql TO 'hbnb_test'@'localhost';
-- grant user hbnb_test all privileges to database hbnb_test_db
GRANT ALL PRIVILEGES ON hbnb_test_db.sql TO 'hbnb_test'@'localhost';
